...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "http://d3b5-136-185-101-18.ngrok.io/get-article";
    axios
      .get(url)
      .then(response => {
  ...
  likedArticle = () => {
    const url = "http://d3b5-136-185-101-18.ngrok.io/liked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  unlikedArticle = () => {
    const url = "http://d3b5-136-185-101-18.ngrok.io/unliked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
